...
VALUES (1, 2, 1, 1, 3, '2022-03-01 12:00:00', '2022-03-01 18:00:00', 100, 200, 'cafeTwitter', '010-1234-5678',
        'RENTAL_APPROVED', 'PRIVATE', 'SMOOTH', 'ABUNDANT'),
       (2, 3, 1, 1, 3, '2022-03-01 12:00:00', '2022-03-01 18:00:00', 100, 200, 'cafeTwitter', '010-1234-5678',
        'RENTAL_APPROVED', 'PRIVATE', 'SMOOTH', 'ABUNDANT');

INSERT INTO memo (id, birthday_cafe_id, content)
VALUES (1, 1, '생일 카페 메모 내용');
