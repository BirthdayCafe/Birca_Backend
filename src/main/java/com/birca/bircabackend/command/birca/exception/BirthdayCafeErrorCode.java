...
public enum BirthdayCafeErrorCode implements ErrorCode {
    ...
    INVALID_UPDATE(5009, 400, "현재 상태로는 해당 정보를 변경할 수 없습니다."),
    UNAUTHORIZED_UPDATE(5010, 400, "생일 카페 변경 권한이 없는 회원입니다."),
    INVALID_UPLOAD_SIZE_REQUEST(5011, 400, "생일 카페 사진은 최대 10장까지 업로드할 수 있습니다.")
